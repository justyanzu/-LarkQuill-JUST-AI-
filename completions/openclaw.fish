...
complete -c openclaw -n "__fish_seen_subcommand_from browser" -a "focus" -d 'Focus a tab by target id, tab id, label, or unique target id prefix'
...
complete -c openclaw -n "__fish_seen_subcommand_from browser" -a "doctor" -d 'Check browser plugin readiness'
...
complete -c openclaw -n "__fish_seen_subcommand_from browser" -a "click-coords" -d 'Click viewport coordinates'
...
complete -c openclaw -n "__fish_seen_subcommand_from doctor" -l deep -d 'Run a live snapshot probe'
